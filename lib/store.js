...
export const putDashboardSnapshot = (id, value) => putJson(`${SNAPSHOT_PREFIX}${id}.json`, value);
export const getDashboardSnapshot = (id) => getJson(`${SNAPSHOT_PREFIX}${id}.json`, null);
